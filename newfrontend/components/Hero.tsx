...
const Hero: React.FC = () => {
  return (
    <section className="relative w-full bg-white dark:bg-background-dark overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-10 py-12 lg:py-24">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 flex flex-col items-start gap-6 text-left z-10">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <button className="flex h-12 px-6 items-center justify-center rounded-lg bg-primary text-white text-base font-bold shadow-lg shadow-primary/25 hover:bg-primary/90 hover:-translate-y-0.5 transition-all">
                View Projects
              </button>
              <button className="flex h-12 px-6 items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-800 text-[#131118] dark:text-white text-base font-bold hover:bg-gray-200 dark:hover:bg-gray-700 transition-all border border-transparent dark:border-gray-700">
                Contact Me
              </button>
            </div>
